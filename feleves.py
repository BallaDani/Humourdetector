...
imp=st.text_input(label='Joke',value=ctr, max_chars=300, type="default", help=None,  args=None, kwargs=None, placeholder="Write your joke here", disabled=False, label_visibility="hidden")
